...
abstract class $HomeModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<HUTeamModel> teams, bool loading, String? error});
}
...
class _$_HomeModel implements _HomeModel {
  ...
  @override
  String toString() {
    return 'HomeModel(teams: $teams, loading: $loading, error: $error)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_teams), loading, error);
...
abstract class _HomeModel implements HomeModel {
  factory _HomeModel(
      {required final List<HUTeamModel> teams,
      final bool loading,
      final String? error}) = _$_HomeModel;
